...
/**
 * The mod_visio course module viewed event class.
 */
class course_module_viewed extends \core\event\course_module_viewed {
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'visio';
    }

    /**
     * Creates an instance from visio record
     *
     * @param stdClass $visio
     * @param cm_info|stdClass $cm
     * @param stdClass $course
     * @return course_module_viewed
     */
    public static function create_from_record($visio, $cm, $course) {
        $event = self::create(array(
            'objectid' => $visio->id,
            'context' => \context_module::instance($cm->id),
            'anonymous' => false,
            'other' => array(
                'anonymous' => $visio->anonymous // Deprecated.
            )
        ));
        $event->add_record_snapshot('course_modules', $cm);
        $event->add_record_snapshot('course', $course);
        $event->add_record_snapshot('visio', $visio);
        return $event;
    }
    ...
    public function can_view($userorid = null) {
        ...
        if ($this->anonymous) {
            ...
            return has_capability('mod/visio:viewreports', $this->context, $userorid);
        }
    }
    ...
    public static function get_objectid_mapping() {
        return array('db' => 'visio', 'restore' => 'visio');
    }
